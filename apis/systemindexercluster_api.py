...
class SystemindexerclusterApi(object):
    ...
    def cluster_health(self, **kwargs):
        ...
        :return: ClusterHealth If the method is called asynchronously, returns the request thread.
        """
    ...
    def cluster_name(self, **kwargs):
        ...
        :param callback function: The callback function for asynchronous request. (optional)
        :return: ClusterName If the method is called asynchronously, returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
