...
class PluginsorggraylogpluginsusagestatisticsoptoutApi(object):
    ...
    def get_opt_out_state(self, **kwargs):
        ...
        :return:\s UsageStatsOptOutState If the method is called asynchronously, returns the request thread.
        """
    ...
    def get_opt_out_state_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'GET', path_params, query_params, header_params, body=body_params, post_params=form_params, files=local_var_files, response_type='UsageStatsOptOutState', auth_settings=auth_settings, callback=params.get('callback'), _return_http_data_only=params.get('_return_http_data_only'))
