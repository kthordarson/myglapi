...
class SimulationResponse(object):
    def __init__(self, messages=None, simulation_trace=None, took_microseconds=None):
        ...
        """
        self.swagger_types = {
            'messages': 'list[object]', 'simulation_trace': 'list[object]', 'took_microseconds': 'int'
        }

        self.attribute_map = {
            'messages': 'messages', 'simulation_trace': 'simulation_trace', 'took_microseconds': 'took_microseconds'
        }
